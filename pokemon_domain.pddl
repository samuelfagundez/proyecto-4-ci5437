(define (domain pokemon-world)
    ...
    (:action collect-first-masterball
        ...
        :precondition (and (at ?p ?l1) (at ?c ?l1) (open ?c) (in ?o ?c) (not (empty ?c)) (has-no-masterball ?p) (not (has-one-masterball ?p)) (not (has-two-masterball ?p)) (not (has-three-masterball ?p)) )
        :effect (and (empty ?c) (not (has-no-masterball ?p)) (has-one-masterball ?p))
    )

    (:action collect-second-masterball
        :parameters (?p - player ?c - chest ?l1 - location ?o - masterball)
        :precondition (and (at ?p ?l1) (at ?c ?l1) (open ?c) (in ?o ?c) (has-one-masterball ?p) (not (empty ?c)) (not (has-no-masterball ?p)) (not (has-two-masterball ?p)) (not (has-three-masterball ?p))) 
        :effect (and (empty ?c) (not (has-one-masterball ?p)) (has-two-masterball ?p))
    )

    (:action collect-third-masterball
        :parameters (?p - player ?c - chest ?l1 - location ?o - masterball)
        :precondition (and (at ?p ?l1) (at ?c ?l1) (open ?c) (in ?o ?c) (has-two-masterball ?p) (not (empty ?c)) (not (has-no-masterball ?p)) (not (has-one-masterball ?p)))
    ...
    (:action capture-first-legendary-pokemon-having-one-masterball
        ...
        :precondition (and (at ?p ?l1) (at ?lp ?l2) (border ?l1 ?l2) (has-one-masterball ?p) (not (has-two-masterball ?p)) (not (has-three-masterball ?p)) (has-no-legendary-pokemon ?p) (not (has-one-legendary-pokemon ?p)) (not (has-two-legendary-pokemon ?p)) (not (has-no-masterball ?p)))
    ...
    (:action capture-first-legendary-pokemon-having-two-masterball
        :parameters (?p - player ?l1 - location ?l2 - location ?lp - legendarypokemon)
        :precondition (and (at ?p ?l1) (at ?lp ?l2) (border ?l1 ?l2) (has-two-masterball ?p) (not (has-one-masterball ?p)) (not (has-three-masterball ?p)) (has-no-legendary-pokemon ?p) (not (has-one-legendary-pokemon ?p)) (not (has-two-legendary-pokemon ?p)) (not (has-no-masterball ?p)))
    ...
    (:action capture-first-legendary-pokemon-having-three-masterball
        :parameters (?p - player ?l1 - location ?l2 - location ?lp - legendarypokemon)
        :precondition (and (at ?p ?l1) (at ?lp ?l2) (border ?l1 ?l2) (has-three-masterball ?p) (not (has-one-masterball ?p)) (not (has-two-masterball ?p)) (has-no-legendary-pokemon ?p) (not (has-one-legendary-pokemon ?p)) (not (has-two-legendary-pokemon ?p)) (not (has-no-masterball ?p)))
    ...
    (:action capture-second-legendary-pokemon-having-one-masterball
        :parameters (?p - player ?l1 - location ?l2 - location ?lp - legendarypokemon)
        :precondition (and (at ?p ?l1) (at ?lp ?l2) (border ?l1 ?l2) (has-one-masterball ?p) (not (has-two-masterball ?p)) (not (has-three-masterball ?p)) (has-one-legendary-pokemon ?p) (not (has-two-legendary-pokemon ?p)) (not (has-no-legendary-pokemon ?p)) (not (has-no-masterball ?p)) )
    ...
    (:action capture-second-legendary-pokemon-having-two-masterball
        :parameters (?p - player ?l1 - location ?l2 - location ?lp - legendarypokemon)
        :precondition (and (at ?p ?l1) (at ?lp ?l2) (border ?l1 ?l2) (has-two-masterball ?p) (not (has-one-masterball ?p)) (not (has-three-masterball ?p)) (has-one-legendary-pokemon ?p) (not (has-two-legendary-pokemon ?p)) (not (has-no-legendary-pokemon ?p)) (not (has-no-masterball ?p)))
    ...
    (:action capture-third-legendary-pokemon-having-one-masterball
        :parameters (?p - player ?l1 - location ?l2 - location ?lp - legendarypokemon)
        :precondition (and (at ?p ?l1) (at ?lp ?l2) (border ?l1 ?l2) (has-one-masterball ?p) (not (has-two-masterball ?p)) (not (has-three-masterball ?p)) (has-two-legendary-pokemon ?p) (not (has-one-legendary-pokemon ?p)) (not (has-no-legendary-pokemon ?p)) (not (has-no-masterball ?p)))
